...
from .state import Q, TSFourEqConsFields, TSFourEqConsState
...
class Exact(TSFourEqScheme):
    ...
    def solve_RP(self, Q_L: Q, Q_R: Q, Qc: TSFourEqConsState, normals: np.ndarray):
        fields = Q.fields
        cfields = TSFourEqConsFields
